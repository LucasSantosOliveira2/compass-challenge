...
export const Time = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20" fill="none">
            <g opacity="0.75">
                <path d="M8.90123 13.4568L11.8642 14.4444C11.8642 14.4444 19.2716 12.963 20.2593 12.963C21.2469 12.963 21.2469 13.9506 20.2593 14.9383C19.2716 15.9259 15.8148 18.8889 12.8519 18.8889C9.88889 18.8889 7.91358 17.4074 5.93827 17.4074H1" stroke="#FC8019" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <path d="M11.3701 1.11111H16.3084V5.55556H11.3701V1.11111Z" stroke="#FC8019" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </g>
        </svg>
    )
}